...
<html lang="en">
	<head>
		...
		<title>EZride - Yearly Most Demand Vehicle Report</title>
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Yearly Most Demand Vehicle Report</h3>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<form>
									...
									<select class="form-control" name="year" onchange="showUser(this.value)">
			    ...
			    if (str == "") {
			        ...
			        xmlhttp.onreadystatechange = function() {
			            if (this.readyState == 4 && this.status == 200) {
			                document.getElementById("datatable-buttons").innerHTML = this.responseText;
			            }
			        };
