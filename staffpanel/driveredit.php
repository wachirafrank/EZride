...
<html lang="en">
	<head>
		...
		<title>EZride - Manager Panel</title>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<form method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Driver Stats
										</label>

										<?php
											$driverstatus = $rowgetdriver['driverstatus'];
											if ($driverstatus == 'employee') {
												$echeck = 'checked';
												$fcheck = '';
											}
											else{
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="radio" value="employee" <?php echo $echeck; ?> name="driverstatus"> Employee
											<input type="radio" value="freelance" <?php echo $fcheck; ?> name="driverstatus"> Freelance
										</div>
									</div>
		...
		<?php
			...
			if (isset($_POST['submit'])):
				...
				if ($driverphoto) {
					...
					mysql_query("update Drivers set drivername ='$drivername', driveremail ='$driveremail', drivercost ='$drivercost', driverphoto='$driverphoto', driverstatus ='$driverstatus' where driverid = '$driverid'");
						echo "<script>swal({
						title: 'Success!',
					...
					mysql_query("update Drivers set drivername ='$drivername', driveremail ='$driveremail', drivercost ='$drivercost', driverstatus ='$driverstatus' where driverid = '$driverid'");
						echo "<script>swal({
						title: 'Success!',
						text: 'Driver Information has been updated!',
						type: 'success',
