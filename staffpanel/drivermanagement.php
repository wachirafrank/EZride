					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
								<?php
									$getalldriversql = mysql_query("Select * from Drivers where officeid = '$officeid' AND driverid != 'nodriver' AND Active = 1");
								?>
									<div class="x_content">
					                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
											...
											<tbody>
												<?php
													while ($rowgetalldrivers = mysql_fetch_assoc($getalldriversql)) {
												?>
												<tr>
													...
													<td><?php echo $rowgetalldrivers['driverstatus']; ?></td>
