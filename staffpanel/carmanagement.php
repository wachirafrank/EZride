...
<html lang="en">
	<head>
		...
		<title>EZride - Car Management</title>
					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
								<?php
									$getallcarsql = mysql_query("SELECT Cars.*, Officecars.* FROM Cars, OfficeCars WHERE Cars.carno = OfficeCars.carno AND OfficeCars.officeid = '$officeid'");
								?>
									<div class="x_content">
