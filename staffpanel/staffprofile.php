...
<html lang="en">
	<head>
		...
		<title>EZride - Change Profile</title>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<form method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="staffusername">Staff Username
										</label>
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="staffname">Staff Name
										</label>
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="staffemail">Staff Email
										</label>
		...
		if (isset($_POST['submit'])):
			...
			if($staffphoto) {
					...
					if(!in_array($ext, $allowfiletype) ) {
						...
						$updatestaffinfosql = mysql_query("update staffs set staffname = '$staffname', staffemail = '$staffemail', staffphoto = '$staffphoto' where staffid = '$staffid'") or die(mysql_error());
						echo "<script>swal({
						title: 'Success!',
				...
				$updatestaffinfosql = mysql_query("update staffs set staffname = '$staffname', staffemail = '$staffemail' where staffid = '$staffid'") or die(mysql_error());
				echo "<script>swal({
				title: 'Success!',
				text: 'Your staff information has been updated!',
				type: 'success',
