...
<html lang="en">
	<head>
		...
		<title>EZride - Customer Management</title>
					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
								<?php
									$getallcustomersql = mysql_query("Select * from Customers where active = true");
								?>
									<div class="x_content">
					                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
											...
											<tbody>
												<?php
													while ($rowgetallcustomers = mysql_fetch_assoc($getallcustomersql)) {
												?>
												<tr>
