...
<html lang="en">
	<head>
		...
		<title>EZride - Change Password</title>
		...
		if (isset($_POST['submit'])):
	        ...
	        if ($newpassword != $confirmpassword) {
			    ...
			    if (7 > strlen($newpassword)) {
		            ...
		            $checkpasswordsql = mysql_query("SELECT * FROM staffs where staffid = '$staffid' AND staffpassword = '$oldpassword'") or die(mysql_error());
		            ...
		            if ($rowcheckpassword < 1) {
		                ...
		                $changepasswordsql = mysql_query("UPDATE staffs set staffpassword = '$newpassword' where staffid = '$staffid'") or die(mysql_error());
				            echo "<script>swal({
				            title: 'Success!',
