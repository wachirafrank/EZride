				...
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0;">
							<a href="sdashboard.php" class="site_title"><i class="fa fa-car"></i><span>EZride</span></a>
						</div>
            ...
            <div class="row top_tiles">
              ...
              <!-- <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12"> -->
                <div class="tile-stats">
                  ...
                  <p>You have <?php echo $newbooking; ?> car reviews in this month!</p>
                <!-- </div> -->
              </div>
              <!-- <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12"> -->
                <div class="tile-stats">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row" style="border-bottom: 1px solid #E0E0E0; padding-bottom: 5px; margin-bottom: 5px;">
                      <div class="col-md-7" style="overflow:hidden;">
                          <a href="#"><img src="../images/design/booking.png" height="130" style="display: inline-block;"></a>
                      ...
                      <div class="col-md-5">
                        <div class="row" style="text-align: center;">
                          <div class="col-md-4">
	                          <a href="#"><img src="../images/design/1.png" height="110" style="margin: 5px 10px 10px 0" alt=""></a>
                            <h4 style="margin:0">Customer Report</h4>
                          </div>
                          <div class="col-md-4">
	                          <a href="#"><img src="../images/design/2.png" height="110" style="margin: 5px 10px 10px 0" alt=""></a>
                            <h4 style="margin:0">Driver Report</h4>
                          </div>
                          <div class="col-md-4">
	                          <a href="#"><img src="../images/design/3.png" height="110" style="margin: 5px 10px 10px 0" alt=""></a>
