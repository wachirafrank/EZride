...
<html lang="en">
	<head>
		...
		<title>EZride - Booking Detail</title>
				...
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0;">
							<a href="#" class="site_title"><i class="fa fa-car"></i><span>EZride</span></a>
						</div>
							...
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td>INR<?php echo $rowgetcar['carcost']; ?> per six hours</td>
										<td>INR<?php echo floor($rowgetcar['carcost']*($durationinhours/6)); ?></td>
									</tr>
